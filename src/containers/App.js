  ...
  return (
    <Router>
      ...
      <Switch>
        ...
        <Route  path="/tour" component = {TourContainer}></Route>
        ...
        <Route exact path="/tourdetail" component={TourDetailContainer}></Route>
        ...
        <Route path="/confirmbooking" component={ConfirmBookingContainer}></Route>
